...
0. (not scripted)                 Cohort clinical/participant metadata --
                                   ...
                                   de_meta_after_preprocess.tsv -- sourced
                                   from the original Callahan et al. 2017
                                   public dataset and the Borum et al. 2025
                                   trial data respectively. Not derived from
                                   sequencing and not regenerated by any
                                   script in this repo.
